...
class Oscillator_1_Jacobi_DD_microstep(Fmi2Slave):
    ...
    def do_step(self, current_time, step_size):
        t_f = current_time + step_size #Macrostep, given when instantiated
        while current_time < t_f:
            self.v_1, self.x_1 = self.oscillator_1(self.x_2, self.micro, self.v_1, self.x_1)
