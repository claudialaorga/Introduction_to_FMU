...
class Oscillator_1_Jacobi_FD_microstep(Fmi2Slave):
    ...
    def __init__(self, **kwargs):
        ...
        self.micro = 0.0001  # Time step, forces initialization as a variable
        self.v_1_old=100
        self.x_1_old=0
        self.x_2_old=0
        self.FC = 0
    ...
    def do_step(self, current_time, step_size):
        ...
        while current_time < t_f:
            self.v_1, self.x_1, self.FC = self.oscillator_1(self.x_2, self.micro, self.v_1, self.x_1)
